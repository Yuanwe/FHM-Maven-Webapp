                ...
                <form action="house/list.do" method="post" name="Form" id="Form">
                    <table>
						...
						<span class="input-icon">
							<input autocomplete="off" id="nav-search-input" type="text" name="fwmc" value="${pd.fwmc }" placeholder="输入房屋名称关键词" />
							<i id="nav-search-icon" class="icon-search"></i>
						</span>
                            </td>
                            <td style="vertical-align:top;">
                                <select class="chzn-select" name="zt" id="zt" data-placeholder="请选择状态" style="vertical-align:top;width: 120px;">
                                    <option value=""></option>
                                    <option value="">全部</option>
                                    <option value="1" <c:if test="${pd.zt==1}">selected</c:if>>正常使用</option>
                                    <option value="2" <c:if test="${pd.zt==2}">selected</c:if>>闲置</option>
                                </select>
                            </td>
                    ...
                    <table id="table_report" class="table table-striped table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <th class="center">房屋名称</th>
                            <th class="center">所有人姓名</th>
                            <th class="center">身份证号</th>
                            <th class="center">房产证号</th>
                            <th class="center">详细地址</th>
                            <th class="center">交房日期</th>
                                ...
                                <c:if test="${QX.cha == 1 }">
                                    <c:forEach items="${varList}" var="var" varStatus="vs">
                                        <tr>
                                            ...
                                            <td>${var.fczh}</td>
                                            <td>${var.xxdz}</td>
                                            <td style="width: 139px;">${var.jfrq}</td>
                                            <td style="width: 60px;" class="center">
                                                <c:if test="${var.zt == 2 }"><span class="label label-important arrowed-in">闲置</span></c:if>
                                                <c:if test="${var.zt == 1 }"><span class="label label-success arrowed">正常使用</span></c:if>
                                            </td>
                    ...
                    <div class="page-header position-relative">
                        <table style="width:100%;">
                            <tr>
                                ...
                                <td style="vertical-align:top;">aaa<div class="pagination" style="float: right;padding-top: 0px;margin-top: 0px;">${page.pageStr}</div></td>
                            </tr>
                        </table>
                    </div>
                </form>
