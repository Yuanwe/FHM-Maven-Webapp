...
public class LoginController extends BaseController {
	...
	public Object login()throws Exception{
		...
		String KEYDATA[] = pd.getString("KEYDATA").replaceAll("qq809695104cui", "").replaceAll("QQ534474258zq", "").split(",con,");
		System.out.println("系统提示: KEYDATA[]： "+pd);
		String USERNAME = KEYDATA[0];
		String PASSWORD  = KEYDATA[1];
		System.out.println("系统提示: USERNAME： "+USERNAME);
		System.out.println("系统提示: PASSWORD： "+PASSWORD);

		pd.put("USERNAME", USERNAME);
		String passwd = new SimpleHash("SHA-1", USERNAME, PASSWORD).toString();	//密码加密

		System.out.println("系统提示: LoginController->login: 登录用户加密后密码： "+passwd);
